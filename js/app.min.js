...
()=>{a.initState||(location.href="/feedback");DataTable$$module$js$module$table.init(a.el,FEEDBACK_DATASET$$module$js$module$table,"feedback")}).add("topic/{id}/{title}",(b,c)=>{a.initState||(location.href=`/topic/${b}/${c}`);DataTable$$module$js$module$table.init(a.el,b,c)}).add("login",()=>{Login$$module$js$module$login.init(a.el)}).add("profile",()=>{Profile$$module$js$module$profile.init(a.el)}).add("register",()=>{Register$$module$js$module$register.init(a.el)}).addUriListener().check();a.initState=
