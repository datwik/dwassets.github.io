...
window.readOnlyWebsite||Login$$module$js$module$login.initAuthMenuItems()},_initRouter:function(){var a=this;this._router=new Router({mode:"history",page404:b=>{b=a.errorTemplate({color:"yellow",title:"Error 404 - Page NOT Found!",message:`The path '/${b}' does not exist on this site`});a.el.html(b)}});a._router.add("/",()=>{Home$$module$js$module$home.init(a.el)}).add("topic",()=>{TopicTable$$module$js$module$topic_table.init(a.el)}).add("ask",()=>{AddTopic$$module$js$module$add_topic.init(a.el)}).add("feedback",
()=>{a.initState||(location.href="/feedback");DataTable$$module$js$module$table.init(a.el,FEEDBACK_DATASET$$module$js$module$table,"feedback")}).add("topic/{id}/{title}",(b,c)=>{a.initState||(location.href=`/topic/${b}/${c}`);DataTable$$module$js$module$table.init(a.el,b,c)}).add("login",()=>{Login$$module$js$module$login.init(a.el)}).add("register",()=>{Register$$module$js$module$register.init(a.el)}).addUriListener().check();a.initState=!1},router:function(){return this._router}};
