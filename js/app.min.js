...
$("*[data-action='search-clear']").click(c=>{c.preventDefault();b.search=null;b._navigatePage()})},topic_events:function(a){let b=this,c=a.topic.records[0].id;$("*[data-action='delete-topic']").off();$("*[data-action='delete-topic']").click(d=>{d.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var e=document.datwik_api_url;modal_helper$$module$js$util$modal.show({template:b.confirmModalTemplate,message:"Are you sure you want to delete this topic?",confirmToastMessage:"Topic deleted",
onConfirm:function(){return rest$$module$js$util$util.delete(e+"/topic/"+c)}}).then(()=>{location.href="/"}).catch(function(f){})}else showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='design-topic']").off();$("*[data-action='design-topic']").click(d=>{d.preventDefault();location.href=`/design/${c}/${this.dataset_title}`});$("*[data-action='approve-topic']").off();$("*[data-action='approve-topic']").click(d=>{b._approveItem(d)});$("*[data-action='report-topic']").off();$("*[data-action='report-topic']").click(d=>
{b._reportItem(d)});$("*[data-action='update-topic']").off();$("*[data-action='update-topic']").click(d=>{d.preventDefault();Login$$module$js$module$login.isAuthenticated()?($('*[data-section^="topic-display-"]').addClass("d-none"),$('*[data-section^="topic-edit-"]').removeClass("d-none")):showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='topic-edit-cancel']").off();$("*[data-action='topic-edit-cancel']").click(d=>{d.preventDefault();$('*[data-section^="topic-edit-"]').addClass("d-none");
$('*[data-section^="topic-display-"]').removeClass("d-none")});$("*[data-action='topic-edit-save']").off();$("*[data-action='topic-edit-save']").click(d=>{d.preventDefault();d=a.topic;let e=d.records[0],f=$("#topic-question-value").val(),g=$("#topic-tags-value").val();g=g.split(",");let h=$("#topic-description-value").val(),k=[f,e.vals[1],g,h];d=dataset_helper$$module$js$util$util.createForUpdate(d.meta,e.id,k);rest$$module$js$util$util.put(document.datwik_api_url+"/topic/",d).then(()=>{e.vals=k;
toast_helper$$module$js$util$modal.show("Saved topic","text-white bg-success");b._navigatePage()}).catch(l=>{toast_helper$$module$js$util$modal.show(l.message,"text-white bg-danger")})})},_setLastPage:function(){this.page=Math.floor(window.topic_data.dataset.meta.stats.row_count/window.topic_data.dataset.filter.size)+1;this.sort=this.search=null},_approveItem:function(a){a.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var b=$(a.currentTarget).data("record-id");rest$$module$js$util$util.post(document.datwik_api_url+
