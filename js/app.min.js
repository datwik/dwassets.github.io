document.datwik_api_url="https://api2.datwik.com";
let buildParams$$module$js$util$util=function(a,b){var c=[];b.page&&c.push(`page=${b.page}`);b.sort&&c.push(`sort=${b.sort}`);b.search&&c.push(`search=${b.search}`);b.tag&&c.push(`tag=${b.tag}`);return a+(0<c.length?"?"+c.join("&"):"")},loadParams$$module$js$util$util=function(a){var b=window.location.href.slice(window.location.href.indexOf("?")+1);b=new URLSearchParams(b);var c=parseInt(b.get("page"));a.page=isNaN(c)?1:Math.max(1,c);c=parseInt(b.get("sort"));a.sort=isNaN(c)?null:c;a.search=b.get("search");
a.tag=b.get("tag")},titleWords$$module$js$util$util=function(a){if(!a)return"";a=a.trim().toLowerCase().replace(/[^a-zA-Z]+/g,"|");if(!a)return"";a=a.split("|");return a.length?a.slice(0,5).filter(b=>2<b.trim().length).join("-"):""};String.prototype.capitalize=function(){return this.replace(/(^|\s)([a-z])/g,function(a,b,c){return b+c.toUpperCase()})};
...
type:"EMAIL",id:1},{name:"category",type:"OPTION",options:[{d:1,v:"General"},{d:2,v:"Registration"},{d:3,v:"Volunteer"},{d:4,v:"Bug/Issue"},{d:5,v:"Security/Vulnerability"},{d:6,v:"Enhancement"}],id:2},{name:"message",type:"TEXTAREA",id:3}]}},rest$$module$js$util$util={get:async function(a){var b=new Date;return axios({url:a,method:"get",headers:{}}).then(function(c){console.log("get",": ",new Date-b);return c.data}).catch(function(c){throw Error(c);})},_change:async function(a,b,c){var d=new Date;
return axios({url:a,method:c,headers:{},data:b,withCredentials:!0}).then(function(e){console.log(c,": ",new Date-d);return e.data}).catch(e=>{if(e.response&&e.response.data.m)throw Error(e.response.data.m);throw Error(e.message);})},post:async function(a,b){return this._change(a,b,"post")},put:async function(a,b){return this._change(a,b,"put")},delete:async function(a,b){return this._change(a,b,"delete")}};var module$js$util$util={};module$js$util$util.FieldType=FieldType$$module$js$util$util;
module$js$util$util.buildParams=buildParams$$module$js$util$util;module$js$util$util.compile_template=compile_template$$module$js$util$util;module$js$util$util.dataset_helper=dataset_helper$$module$js$util$util;module$js$util$util.formatMoney=formatMoney$$module$js$util$util;module$js$util$util.isEmpty=isEmpty$$module$js$util$util;module$js$util$util.isNotEmpty=isNotEmpty$$module$js$util$util;module$js$util$util.loadParams=loadParams$$module$js$util$util;module$js$util$util.meta_helper=meta_helper$$module$js$util$util;
module$js$util$util.record_change_helper=record_change_helper$$module$js$util$util;module$js$util$util.rest=rest$$module$js$util$util;module$js$util$util.titleWords=titleWords$$module$js$util$util;let toast_helper$$module$js$util$modal={toastTemplate:Handlebars.compile($("#toast-template").html()),show:function(a,b){$("#app-toast").html(this.toastTemplate({message:a,background:b}));(new bootstrap.Toast($("#toast"))).show()}},modal_helper$$module$js$util$modal={el:"#app-modal",m:function(){return bootstrap.Modal.getOrCreateInstance($(".modal",this.el)[0],{keyboard:!1,backdrop:"static"})},validate:function(a){a.fields.forEach(d=>{record_change_helper$$module$js$util$util.fieldInputs(d).forEach(e=>
...
showNotLoggedInMessage$$module$js$module$contact_us=function(){window.readOnlyWebsite?showContactUsDialog$$module$js$module$contact_us('To get invitation for <img src="/img/datwik-logo-grey.png" width="16" height="16"/> <b>datwik.com</b> <i> alpha testing</i>: <ul> <li> Enter your email address <li> Choose "Registration" <li> Describe your interest (250 letters or less) </ul>We will contact you shortly with next steps.'):toast_helper$$module$js$util$modal.show("Please login to perform this action",
"text-white bg-danger")};var module$js$module$contact_us={};module$js$module$contact_us.showContactUsDialog=showContactUsDialog$$module$js$module$contact_us;module$js$module$contact_us.showNotLoggedInMessage=showNotLoggedInMessage$$module$js$module$contact_us;const FEEDBACK_DATASET$$module$js$module$table=2,DataTable$$module$js$module$table={el:null,loadingTemplate:Handlebars.compile($("#dataset-loading-template").html()),dynamicTableAddModalTemplate:compile_template$$module$js$util$util("#dynamic-table-record-modal-template"),confirmModalTemplate:compile_template$$module$js$util$util("#confirm-modal-template"),dataset_id:null,dataset_title:null,page:0,sort:null,search:null,flexTable:function(){768>screen.width?$(".table-responsive-stack").each(function(a){$(this).find(".table-responsive-stack-thead").show();
$(this).find("thead").hide()}):$(".table-responsive-stack").each(function(a){$(this).find(".table-responsive-stack-thead").hide();$(this).find("thead").show()})},events:function(a){var b=this;window.onresize=function(c){b.flexTable()};$("*[data-action='add']").off();$("*[data-action='add']").click(c=>{c.preventDefault();Login$$module$js$module$login.isAuthenticated()?modal_helper$$module$js$util$modal.show({template:b.dynamicTableAddModalTemplate,title:"Add record",meta:a.meta,confirmToastMessage:"Record added!",
onConfirm:function(){return record_change_helper$$module$js$util$util.addRecord(a.meta)}}).then(()=>{location.reload()}):showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='update']").off();$("*[data-action='update']").click(c=>{c.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var d=$(c.currentTarget).data("record-id");c=a.records.filter(e=>e.id==d)[0];modal_helper$$module$js$util$modal.show({template:b.dynamicTableAddModalTemplate,title:"Edit record",meta:a.meta,
record:c.vals,confirmToastMessage:"Record updated!",onConfirm:function(){return record_change_helper$$module$js$util$util.updateRecord(a.meta,d)}}).then(()=>{location.reload()})}else showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='clone']").off();$("*[data-action='clone']").click(c=>{c.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var d=$(c.currentTarget).data("record-id");c=a.records.filter(e=>e.id==d)[0];modal_helper$$module$js$util$modal.show({template:b.dynamicTableAddModalTemplate,
title:"Clone record",meta:a.meta,record:c.vals,confirmToastMessage:"Record updated!",onConfirm:function(){return record_change_helper$$module$js$util$util.addRecord(a.meta)}}).then(()=>{location.reload()})}else showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='approve']").off();$("*[data-action='approve']").click(c=>{b._approveItem(c)});$("*[data-action='delete']").off();$("*[data-action='delete']").click(c=>{c.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){c=
$(c.currentTarget).data("record-id");var d=dataset_helper$$module$js$util$util.createForDelete(a.meta,[c]),e=document.datwik_api_url;modal_helper$$module$js$util$modal.show({template:b.confirmModalTemplate,message:"Are you sure you want to delete this entry?",confirmToastMessage:"Entry deleted",onConfirm:function(){return rest$$module$js$util$util.delete(e+"/action/dataset",d)}}).then(()=>{location.reload()}).catch(function(f){})}else showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='report']").off();
$("*[data-action='report']").click(c=>{b._reportItem(c)});$("*[data-action='page-next']").off();$("*[data-action='page-next']").click(c=>{c.preventDefault();0!=a.records.length&&(b.page+=1,b._navigatePage())});$("*[data-action='page-previous']").off();$("*[data-action='page-previous']").click(c=>{c.preventDefault();2>this.page||(--b.page,b._navigatePage())});$("*[data-sort-id]").off();$("*[data-sort-id]").click(c=>{c.preventDefault();c=$(c.currentTarget).data("sort-id");b.sort=b.sort?c==b.sort?-b.sort:
c==-b.sort?null:c:c;b._navigatePage()});$("*[data-action='search-record']").off();$("*[data-action='search-record']").click(c=>{c.preventDefault();b.search=$("input[data-input='search-record']")[0].value;b.page=1;b._navigatePage()});$("*[data-action='search-clear']").off();$("*[data-action='search-clear']").click(c=>{c.preventDefault();b.search=null;b._navigatePage()})},topic_events:function(a){let b=this;$("*[data-action='delete-topic']").off();$("*[data-action='delete-topic']").click(c=>{c.preventDefault();
if(Login$$module$js$module$login.isAuthenticated()){var d=a.topic.records[0].id,e=document.datwik_api_url;modal_helper$$module$js$util$modal.show({template:b.confirmModalTemplate,message:"Are you sure you want to delete this topic?",confirmToastMessage:"Topic deleted",onConfirm:function(){return rest$$module$js$util$util.delete(e+"/topic/"+d)}}).then(()=>{location.href="/"}).catch(function(f){})}else showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='approve-topic']").off();
$("*[data-action='approve-topic']").click(c=>{b._approveItem(c)});$("*[data-action='report-topic']").off();$("*[data-action='report-topic']").click(c=>{b._reportItem(c)});$("*[data-action='update-topic']").off();$("*[data-action='update-topic']").click(c=>{c.preventDefault();Login$$module$js$module$login.isAuthenticated()?($('*[data-section^="topic-display-"]').addClass("d-none"),$('*[data-section^="topic-edit-"]').removeClass("d-none")):showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='topic-edit-cancel']").off();
$("*[data-action='topic-edit-cancel']").click(c=>{c.preventDefault();$('*[data-section^="topic-edit-"]').addClass("d-none");$('*[data-section^="topic-display-"]').removeClass("d-none")});$("*[data-action='topic-edit-save']").off();$("*[data-action='topic-edit-save']").click(c=>{c.preventDefault();c=a.topic;let d=c.records[0],e=$("#topic-question-value").val(),f=$("#topic-tags-value").val();f=f.split(",");let g=[e,d.vals[1],f];c=dataset_helper$$module$js$util$util.createForUpdate(c.meta,d.id,g);rest$$module$js$util$util.put(document.datwik_api_url+
"/topic/",c).then(()=>{d.vals=g;toast_helper$$module$js$util$modal.show("Saved topic","text-white bg-success");b._navigatePage()}).catch(h=>{toast_helper$$module$js$util$modal.show(h.message,"text-white bg-danger")})})},_setLastPage:function(){this.page=-1;this.sort=this.search=null},_approveItem:function(a){a.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var b=$(a.currentTarget).data("record-id");rest$$module$js$util$util.post(document.datwik_api_url+"/action/dataset/approve/"+
b).then(c=>{$(`*[data-approve-score-counter='${b}']`).html(c.approve_score)}).catch(c=>{toast_helper$$module$js$util$modal.show("Unable to approve"+(c.message?": "+c.message:""),"text-white bg-danger")})}else showNotLoggedInMessage$$module$js$module$contact_us()},_reportItem:function(a){a.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var b=$(a.currentTarget).data("record-id");modal_helper$$module$js$util$modal.show({template:this.confirmModalTemplate,message:"Are you sure you want to report this entry?",
confirmToastMessage:"Thank you for reporting",onConfirm:function(){return rest$$module$js$util$util.post(document.datwik_api_url+"/action/dataset/report/"+b)}}).catch(c=>{toast_helper$$module$js$util$modal.show("Unable to report"+(c.message?": "+c.message:""),"text-white bg-danger")})}else showNotLoggedInMessage$$module$js$module$contact_us()},_navigatePage:function(){location.href=this._buildParams(`/topic/${this.dataset_id}/${this.dataset_title}`)},_buildParams(a){return buildParams$$module$js$util$util(a,
this)},_loadParams:function(){loadParams$$module$js$util$util(this)},init:function(a,b,c){this.el=a;this.dataset_id=b;this.dataset_title=c;this._loadParams();this.render()},render:async function(){DataTable$$module$js$module$table.events(window.topic_data.dataset);DataTable$$module$js$module$table.topic_events(window.topic_data);this._renderSort()},_renderSort:function(){this.sort&&($("*[data-sort-marker-id]").addClass("d-none"),0<this.sort?$(`*[data-sort-marker-id=${this.sort}][data-sort-marker="down"]`).removeClass("d-none"):
$(`*[data-sort-marker-id=${-this.sort}][data-sort-marker="up"]`).removeClass("d-none"))},_renderSearch:function(){this.search&&($("input[data-input='search-record']")[0].value=this.search)}};var module$js$module$table={};module$js$module$table.DataTable=DataTable$$module$js$module$table;module$js$module$table.FEEDBACK_DATASET=FEEDBACK_DATASET$$module$js$module$table;const TopicTable$$module$js$module$topic_table={el:null,template:Handlebars.compile($("#topic-list-template").html()),loadingTemplate:Handlebars.compile($("#topic-list-loading-template").html()),dynamicTableTemplate:Handlebars.compile($("#topic-list-dynamic-table-template").html()),page:0,sort:null,search:null,tag:null,events:function(a){var b=this;$("*[data-action='topic-show']").off();$("*[data-action='topic-show']").click(c=>{c.preventDefault();c=$(c.currentTarget).data("topic-id");window.app.router().navigateTo(`/topic/${c}`)});
$("*[data-action='topic-tag-search']").off();$("*[data-action='topic-tag-search']").click(c=>{c.preventDefault();b.page=1;b.tag=$(c.currentTarget).data("tag");b._navigatePage()});$("*[data-action='page-next']").off();$("*[data-action='page-next']").click(c=>{c.preventDefault();0!=a.records.length&&(b.page+=1,b._navigatePage())});$("*[data-action='page-previous']").off();$("*[data-action='page-previous']").click(c=>{c.preventDefault();2>this.page||(--b.page,b._navigatePage())})},_navigatePage:function(){window.app.router().navigateTo(this._buildParams("/topic"))},
_buildParams(a){return buildParams$$module$js$util$util(a,this)},_loadParams:function(){loadParams$$module$js$util$util(this)},init:function(a){this.el=a;this._loadParams();this.render()},render:async function(){let a=this;a.el.html(this.loadingTemplate());rest$$module$js$util$util.get(document.datwik_api_url+this._buildParams("/action/dataset/1")).then(b=>{a.el.html(this.template());$("#dynamic-topic-table").html(a.dynamicTableTemplate({data:b,page:a.page}));TopicTable$$module$js$module$topic_table.events(b);
a._renderSort();a._renderSearch()})},_renderSort:function(){this.sort&&($("*[data-sort-marker-id]").addClass("invisible"),0<this.sort?$(`*[data-sort-marker-id=${this.sort}][data-sort-marker="down"]`).removeClass("invisible"):$(`*[data-sort-marker-id=${-this.sort}][data-sort-marker="up"]`).removeClass("invisible"))},_renderSearch:function(){this.search&&($("input[data-input='search-topic']")[0].value=this.search)}};var module$js$module$topic_table={};module$js$module$topic_table.TopicTable=TopicTable$$module$js$module$topic_table;let EmptyField$$module$js$module$add_topic={name:null,type:null,required:!1};
const AddTopic$$module$js$module$add_topic={el:null,template:compile_template$$module$js$util$util("#add-topic-template"),templateSimple:compile_template$$module$js$util$util("#add-topic-simple-template"),templateAdvanced:compile_template$$module$js$util$util("#add-topic-advanced-template"),advancedMode:!1,fields:[{...EmptyField$$module$js$module$add_topic}],events:function(){var a=this;$("*[data-action='topic-add']").off();$("*[data-action='topic-add']").click(b=>{b.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var c=
$("#topic-question-value").val();b=$("#topic-tags-value").val();b=b.split(",");if(a.validate()){var d=a.buildDatasetMeta();b={topic:dataset_helper$$module$js$util$util.createForAdd(meta_helper$$module$js$util$util.topic,[c,null,b]),dataset:{meta:d}};rest$$module$js$util$util.post(document.datwik_api_url+"/topic/",b).then(e=>{toast_helper$$module$js$util$modal.show("Added new topic","text-white bg-success");window.location.href=`/topic/${e.tid}/${titleWords$$module$js$util$util(c)}`}).catch(function(e){toast_helper$$module$js$util$modal.show(e.message,
"text-white bg-danger")})}}else showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='show-advanced']").off();$("*[data-action='show-advanced']").click(b=>{b.preventDefault();a.advancedMode=!a.advancedMode;a.renderSimple();a.renderAdvanced();a.events()});$("*[data-action='field-add']").off();$("*[data-action='field-add']").click(b=>{b.preventDefault();32<=a.fields.length?toast_helper$$module$js$util$modal.show("Topic cannot have more than 32 fields","text-white bg-danger"):(a.recordValues(),
a.fields.push({...EmptyField$$module$js$module$add_topic}),a.renderAdvanced(),a.events())});$("*[data-action='field-remove']").off();$("*[data-action='field-remove']").click(b=>{b.preventDefault();1>=a.fields.length?toast_helper$$module$js$util$modal.show("Topic needs to have at least 1 field","text-white bg-danger"):(b=$(b.currentTarget).data("index"),a.recordValues(),a.fields.splice(b,1),a.renderAdvanced(),a.events())});$("*[data-action='field-up']").off();$("*[data-action='field-up']").click(b=>
{b.preventDefault();b=$(b.currentTarget).data("index");a.recordValues();if(0<b){let c=a.fields.splice(b,1);a.fields.splice(b-1,0,c[0])}a.renderAdvanced();a.events()});$("*[data-action='field-down']").off();$("*[data-action='field-down']").click(b=>{b.preventDefault();b=$(b.currentTarget).data("index");a.recordValues();if(b<a.fields.length-1){let c=a.fields.splice(b,1);a.fields.splice(b+1,0,c[0])}a.renderAdvanced();a.events()})},validate:function(a){document.getElementById("add-topic-form");a=!0;var b=
$("#topic-question-value"),c=$("#topic-tags-value"),d=$("#topic-type-value");[b,c,d].forEach(f=>{f.prop("classList").remove("is-invalid");f.prop("classList").remove("is-valid")});var e=b.val();c.val();c=d.val();(e=validator.isLength(e,{min:5,max:200}))||b.prop("classList").add(e?"is-valid":"is-invalid");a=a&&e;this.advancedMode?(d=this.fields.map((f,g)=>{var h=$(`*[data-field-attribute="${g}-name"]`);f=$(`*[data-field-attribute="${g}-type"]`);g=$(`*[data-field-attribute="${g}-options"]`);[h,f,g].forEach(m=>
{m.prop("classList").remove("is-invalid");m.prop("classList").remove("is-valid")});var k=h.val();let n=f.val(),p=g.val();var l=!0;(k=validator.isLength(k,{min:2,max:50})&&validator.isAlphanumeric(k,"en-US",{ignore:" -"}))||h.prop("classList").add(k?"is-valid":"is-invalid");l=l&&k;(h=0<=n)||f.prop("classList").add(h?"is-valid":"is-invalid");l=l&&h;n==FieldType$$module$js$util$util.OPTION&&(f=validator.isLength(p,{min:3,max:100}),g.prop("classList").add(f?"is-valid":"is-invalid"),l=l&&f);return l}).reduce((f,
g)=>f&&g),a=a&&d):(b=null!=meta_helper$$module$js$util$util.types[c],d.prop("classList").add(b?"is-valid":"is-invalid"),a=a&&b);return a},recordValues:function(){this.fields.forEach((a,b)=>{a.name=$(`*[data-field-attribute="${b}-name"]`).val();a.type=$(`*[data-field-attribute="${b}-type"]`).val();a.required=$(`*[data-field-attribute="${b}-required"]`).is(":checked");a.options=$(`*[data-field-attribute="${b}-options"]`).val()})},buildDatasetMeta:function(){if(this.advancedMode)return this.recordValues(),
{name:"custom",fields:this.fields.map(b=>{b={...b};b.type=Number(b.type);b.options?b.options=b.options.split(",").map((c,d)=>({d,v:c})):delete b.options;b.required||delete b.required;return b})};let a=$("#topic-type-value").val();return meta_helper$$module$js$util$util.types[a]},init:function(a){this.el=a;this.render()},render:async function(){this.el.html(this.template({authenticated:Login$$module$js$module$login.isAuthenticated()}));this.renderSimple();this.renderAdvanced();AddTopic$$module$js$module$add_topic.events()},
renderSimple:function(){$('*[data-section="topic-simple"]').html(this.templateSimple({topic_types:Object.keys(meta_helper$$module$js$util$util.types),authenticated:!0,advancedMode:this.advancedMode}))},renderAdvanced:function(){let a=$('*[data-section="topic-advanced"]');$('*[data-action="show-advanced"]').html(this.advancedMode?"Simple":"Advanced");if(this.advancedMode){var b=Object.keys(FieldType$$module$js$util$util).map(c=>({k:FieldType$$module$js$util$util[c],v:c}));a.html(this.templateAdvanced({authenticated:!0,
field_types:b,fields:this.fields}))}else a.html("")}};var module$js$module$add_topic={};module$js$module$add_topic.AddTopic=AddTopic$$module$js$module$add_topic;const Register$$module$js$module$register={el:null,template:compile_template$$module$js$util$util("#register-template"),events:function(){$("*[data-action='register']").off();$("*[data-action='register']").click(a=>{a.preventDefault();let b={username:$("*[data-input='username']").val(),password:$("*[data-input='password']").val(),email:$("*[data-input='email']").val(),agree_terms_privacy:$("*[data-input='agree_terms_privacy']").is(":checked"),agree_emails:$("*[data-input='agree_emails']").is(":checked")};
...
render:async function(){this.el.html(this.template())}};var module$js$module$home={};module$js$module$home.Home=Home$$module$js$module$home;const app$$module$js$app={el:$("#app"),errorTemplate:Handlebars.compile($("#error-template").html()),_router:null,initState:!0,init:function(){this._initRouter();this._initMenu()},_initMenu:function(){var a=this;$(`a[href$='${window.location.pathname}']`).addClass("active");$("a[data-nav]").on("click",b=>{b.preventDefault();b=$(b.target);$(".nav-link").removeClass("active");b.addClass("active");b=b.attr("href");b=b.substr(b.lastIndexOf("/"));a.router().navigateTo(b)});$("*[data-action='search-topic']").off();
$("*[data-action='search-topic']").click(b=>{b.preventDefault();b=$("input[data-input='search-topic']").val();window.app.router().navigateTo(`/topic/?search=${b}`)});$("*[data-action='search-topic-clear']").off();$("*[data-action='search-topic-clear']").click(b=>{b.preventDefault();$("input[data-input='search-topic']").val("");window.app.router().navigateTo("/")});$("*[data-action='feedback']").off();$("*[data-action='feedback']").click(b=>{b.preventDefault();window.app.router().navigateTo("/feedback")});
$("*[data-action='contact-us']").off();$("*[data-action='contact-us']").click(b=>{b.preventDefault();showContactUsDialog$$module$js$module$contact_us()});window.readOnlyWebsite||Login$$module$js$module$login.initAuthMenuItems()},_initRouter:function(){var a=this;this._router=new Router({mode:"history",page404:b=>{b=a.errorTemplate({color:"yellow",title:"Error 404 - Page NOT Found!",message:`The path '/${b}' does not exist on this site`});a.el.html(b)}});a._router.add("/",()=>{Home$$module$js$module$home.init(a.el)}).add("topic",
()=>{TopicTable$$module$js$module$topic_table.init(a.el)}).add("ask",()=>{AddTopic$$module$js$module$add_topic.init(a.el)}).add("feedback",()=>{DataTable$$module$js$module$table.init(a.el,FEEDBACK_DATASET$$module$js$module$table)}).add("topic/{id}/{title}",(b,c)=>{a.initState||(location.href=`http://localhost:5000/topic/${b}/${c}`);DataTable$$module$js$module$table.init(a.el,b,c)}).add("login",()=>{Login$$module$js$module$login.init(a.el)}).add("register",()=>{Register$$module$js$module$register.init(a.el)}).addUriListener().check();
