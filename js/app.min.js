...
a.tag=b.get("tag")},titleWords$$module$js$util$util=function(a){if(!a)return"";a=a.trim().toLowerCase().replace(/[^a-zA-Z]+/g,"|");if(!a)return"";a=a.split("|");return a.length?a.slice(0,10).filter(b=>2<b.trim().length).join("-"):""};String.prototype.capitalize=function(){return this.replace(/(^|\s)([a-z])/g,function(a,b,c){return b+c.toUpperCase()})};
...
confirmToastMessage:"Entry deleted",onConfirm:function(){return rest$$module$js$util$util.delete(e+"/action/dataset",d)}}).then(()=>{location.reload()}).catch(function(f){})}else showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='report']").off();$("*[data-action='report']").click(c=>{b._reportItem(c)});$("*[data-action='page-next']").off();$("*[data-action='page-next']").click(c=>{c.preventDefault();0!=a.records.length&&(b.page+=1,b._navigatePage())});$("*[data-action='page-previous']").off();
$("*[data-action='page-previous']").click(c=>{c.preventDefault();2>this.page||(--b.page,b._navigatePage())});$("*[data-sort-id]").off();$("*[data-sort-id]").click(c=>{c.preventDefault();c=$(c.currentTarget).data("sort-id");b.sort=b.sort?c==b.sort?-b.sort:c==-b.sort?null:c:c;b._navigatePage()});$("*[data-action='search-record']").off();$("*[data-action='search-record']").click(c=>{c.preventDefault();b.search=$("input[data-input='search-record']")[0].value;b.page=1;b._navigatePage()});$("*[data-action='search-clear']").off();
$("*[data-action='search-clear']").click(c=>{c.preventDefault();b.search=null;b._navigatePage()})},topic_events:function(a){let b=this;$("*[data-action='delete-topic']").off();$("*[data-action='delete-topic']").click(c=>{c.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var d=a.topic.records[0].id,e=document.datwik_api_url;modal_helper$$module$js$util$modal.show({template:b.confirmModalTemplate,message:"Are you sure you want to delete this topic?",confirmToastMessage:"Topic deleted",
onConfirm:function(){return rest$$module$js$util$util.delete(e+"/topic/"+d)}}).then(()=>{location.href="/"}).catch(function(f){})}else showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='approve-topic']").off();$("*[data-action='approve-topic']").click(c=>{b._approveItem(c)});$("*[data-action='report-topic']").off();$("*[data-action='report-topic']").click(c=>{b._reportItem(c)});$("*[data-action='update-topic']").off();$("*[data-action='update-topic']").click(c=>{c.preventDefault();
Login$$module$js$module$login.isAuthenticated()?($('*[data-section^="topic-display-"]').addClass("d-none"),$('*[data-section^="topic-edit-"]').removeClass("d-none")):showNotLoggedInMessage$$module$js$module$contact_us()});$("*[data-action='topic-edit-cancel']").off();$("*[data-action='topic-edit-cancel']").click(c=>{c.preventDefault();$('*[data-section^="topic-edit-"]').addClass("d-none");$('*[data-section^="topic-display-"]').removeClass("d-none")});$("*[data-action='topic-edit-save']").off();$("*[data-action='topic-edit-save']").click(c=>
{c.preventDefault();c=a.topic;let d=c.records[0],e=$("#topic-question-value").val(),f=$("#topic-tags-value").val();f=f.split(",");let g=[e,d.vals[1],f];c=dataset_helper$$module$js$util$util.createForUpdate(c.meta,d.id,g);rest$$module$js$util$util.put(document.datwik_api_url+"/topic/",c).then(()=>{d.vals=g;toast_helper$$module$js$util$modal.show("Saved topic","text-white bg-success");b._navigatePage()}).catch(h=>{toast_helper$$module$js$util$modal.show(h.message,"text-white bg-danger")})})},_setLastPage:function(){this.page=
Math.floor(window.topic_data.dataset.meta.stats.row_count/window.topic_data.dataset.filter.size)+1;this.sort=this.search=null},_approveItem:function(a){a.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var b=$(a.currentTarget).data("record-id");rest$$module$js$util$util.post(document.datwik_api_url+"/action/dataset/approve/"+b).then(c=>{$(`*[data-approve-score-counter='${b}']`).html(c.approve_score)}).catch(c=>{toast_helper$$module$js$util$modal.show("Unable to approve"+(c.message?
": "+c.message:""),"text-white bg-danger")})}else showNotLoggedInMessage$$module$js$module$contact_us()},_reportItem:function(a){a.preventDefault();if(Login$$module$js$module$login.isAuthenticated()){var b=$(a.currentTarget).data("record-id");modal_helper$$module$js$util$modal.show({template:this.confirmModalTemplate,message:"Are you sure you want to report this entry?",confirmToastMessage:"Thank you for reporting",onConfirm:function(){return rest$$module$js$util$util.post(document.datwik_api_url+
"/action/dataset/report/"+b)}}).catch(c=>{toast_helper$$module$js$util$modal.show("Unable to report"+(c.message?": "+c.message:""),"text-white bg-danger")})}else showNotLoggedInMessage$$module$js$module$contact_us()},_navigatePage:function(){location.href=this._buildParams(`/topic/${this.dataset_id}/${this.dataset_title}`)},_buildParams(a){return buildParams$$module$js$util$util(a,this)},_loadParams:function(){loadParams$$module$js$util$util(this)},init:function(a,b,c){this.el=a;this.dataset_id=b;
this.dataset_title=c;this._loadParams();this.render()},render:async function(){DataTable$$module$js$module$table.events(window.topic_data.dataset);DataTable$$module$js$module$table.topic_events(window.topic_data);this._renderSort()},_renderSort:function(){this.sort&&($("*[data-sort-marker-id]").addClass("d-none"),0<this.sort?$(`*[data-sort-marker-id=${this.sort}][data-sort-marker="down"]`).removeClass("d-none"):$(`*[data-sort-marker-id=${-this.sort}][data-sort-marker="up"]`).removeClass("d-none"))},
_renderSearch:function(){this.search&&($("input[data-input='search-record']")[0].value=this.search)}};var module$js$module$table={};module$js$module$table.DataTable=DataTable$$module$js$module$table;module$js$module$table.FEEDBACK_DATASET=FEEDBACK_DATASET$$module$js$module$table;const TopicTable$$module$js$module$topic_table={el:null,template:Handlebars.compile($("#topic-list-template").html()),loadingTemplate:Handlebars.compile($("#topic-list-loading-template").html()),dynamicTableTemplate:Handlebars.compile($("#topic-list-dynamic-table-template").html()),page:0,sort:null,search:null,tag:null,events:function(a){var b=this;$("*[data-action='topic-show']").off();$("*[data-action='topic-show']").click(c=>{c.preventDefault();c=$(c.currentTarget).data("topic-id");window.app.router().navigateTo(`/topic/${c}`)});
