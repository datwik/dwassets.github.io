...
let buildParams$$module$js$util$util=function(a,b){var c=[];b.page&&c.push(`page=${b.page}`);b.sort&&c.push(`sort=${b.sort}`);b.search&&c.push(`search=${b.search}`);b.tag&&c.push(`tag=${b.tag}`);b.layout&&c.push(`layout=${b.layout}`);b.record&&c.push(`record=${b.record}`);return a+(0<c.length?"?"+c.join("&"):"")},loadParams$$module$js$util$util=function(a){var b=window.location.href.slice(window.location.href.indexOf("?")+1);b=new URLSearchParams(b);var c=parseInt(b.get("page"));a.page=isNaN(c)?1:
Math.max(1,c);c=parseInt(b.get("sort"));a.sort=isNaN(c)?null:c;c=parseInt(b.get("record"));a.record=isNaN(c)?null:c;a.search=b.get("search");a.tag=b.get("tag");a.layout=b.get("layout")},slug$$module$js$util$util=function(a){if(!a)return"";a=a.trim().toLowerCase().replace(/[^a-zA-Z]+/g,"|");if(!a)return"";a=a.split("|");return a.length?a.slice(0,10).filter(b=>2<b.trim().length).join("-"):""};String.prototype.capitalize=function(){return this.replace(/(^|\s)([a-z])/g,function(a,b,c){return b+c.toUpperCase()})};
let formatMoney$$module$js$util$util=function(a){a&&""!=a||(a="0.00");let b=a?a:"0.00";b=a&&a.toFixed?a.toFixed(2):b;return parseFloat(b).toLocaleString("en-CA",{style:"currency",currency:"CAD"})},parseMoneyToDecimalString$$module$js$util$util=function(a){try{let b=parseFloat(a.replace(/[$,\s]+/g,""));return!b||Number.isNaN(b)?a:b.toString()}catch(b){return a}},isEmpty$$module$js$util$util=function(a,b){return!isNotEmpty$$module$js$util$util(a,b)},isNotEmpty$$module$js$util$util=function(a,b){var c=
void 0!=a&&null!=a;if(c)if(b)c=0<b.filter(d=>d.d==a).length;else if("string"===typeof a||a instanceof String)c=""!=a.trim();return c},FieldType$$module$js$util$util={INTEGER:0,STRING:1,MONEY:2,URL:4,OPTION:9,TEXTAREA:11,EMAIL:12},MetaObjectType$$module$js$util$util={FEEDBACK:2,CONTACT_US:3},compile_template$$module$js$util$util=function(a){a=$(a).html();return void 0!==a?Handlebars.compile(a):null},record_change_helper$$module$js$util$util={fieldInputs:function(a){let b=$(`#dynamic-field-${a.id}-value`);
return"URL"==a.type?[b,$(`#dynamic-field-${a.id}-url`)]:[b]},recordModalValues:function(a){let b=[];a.fields.forEach(c=>{let d=record_change_helper$$module$js$util$util.fieldInputs(c),e=d[0].val();"URL"==c.type?(c=d[1].val(),b.push({value:e,url:c})):"MONEY"==c.type?b.push(parseMoneyToDecimalString$$module$js$util$util(e)):b.push(e)});return b},addRecordContactUs:function(a){let b=this.recordModalValues(a);a=dataset_helper$$module$js$util$util.createForAdd(a,b);return rest$$module$js$util$util.post(document.datwik_api_url+
"/action/contactus",a)},addRecord:function(a){let b=this.recordModalValues(a);a=dataset_helper$$module$js$util$util.createForAdd(a,b);return rest$$module$js$util$util.post(document.datwik_api_url+"/action/dataset",a)},updateRecord:function(a,b){let c=this.recordModalValues(a);a=dataset_helper$$module$js$util$util.createForUpdate(a,b,c);return rest$$module$js$util$util.put(document.datwik_api_url+"/action/dataset",a)}},dataset_helper$$module$js$util$util={initDataSet:function(){let a=new Map;a.records=
[];return a},setValues:function(a,b,c){let d=[];b.vals=d;a.fields.forEach(function(e,f){f=c[f];if("INTEGER"==e.type||"OPTION"==e.type||"MONEY"==e.type)if(null==f||""==f)f=null;else try{f=Number(f)}catch(g){f=null}d.push(f)})},createForAdd:function(a,b){let c=this.initDataSet();c.meta=a;let d=new Map;c.records.push(d);this.setValues(a,d,b);return c},createForUpdate:function(a,b,c){let d=this.initDataSet();d.meta=a;let e=new Map;e.id=b;d.records.push(e);this.setValues(a,e,c);return d},createForDelete:function(a,
b){let c=this.initDataSet(a);c.meta={id:a.id};b.forEach(d=>{c.records.push({id:d})});return c}},meta_helper$$module$js$util$util={topic:{name:"topic",fields:[{name:"topic",type:FieldType$$module$js$util$util.STRING},{name:"dataset",type:FieldType$$module$js$util$util.INTEGER},{name:"tags",type:FieldType$$module$js$util$util.STRING},{name:"description",type:FieldType$$module$js$util$util.TEXTAREA}]},types:{service:{name:"service",fields:[{name:"vendor",type:FieldType$$module$js$util$util.STRING},{name:"product",
type:FieldType$$module$js$util$util.URL},{name:"price",type:FieldType$$module$js$util$util.MONEY},{name:"frequency",type:FieldType$$module$js$util$util.OPTION,options:[{d:1,v:"Month"},{d:2,v:"Year"},{d:3,v:"Week"},{d:4,v:"2 weeks"},{d:5,v:"3 months"},{d:6,v:"6 months"},{d:7,v:"Day"},{d:8,v:"2 years"}]},{name:"description",type:FieldType$$module$js$util$util.TEXTAREA}]},product:{name:"product",fields:[{name:"vendor",type:FieldType$$module$js$util$util.STRING},{name:"product",type:FieldType$$module$js$util$util.URL},
{name:"price",type:FieldType$$module$js$util$util.MONEY},{name:"description",type:FieldType$$module$js$util$util.TEXTAREA}]},link:{name:"link",fields:[{name:"name",type:FieldType$$module$js$util$util.URL},{name:"description",type:FieldType$$module$js$util$util.TEXTAREA}]}},contact_us_render_meta:{type:MetaObjectType$$module$js$util$util.CONTACT_US,fields:[{name:"email",type:"EMAIL",id:1},{name:"category",type:"OPTION",options:[{d:1,v:"General"},{d:2,v:"Registration"},{d:3,v:"Volunteer"},{d:4,v:"Bug/Issue"},
{d:5,v:"Security/Vulnerability"},{d:6,v:"Enhancement"}],id:2},{name:"message",type:"TEXTAREA",id:3}]}},rest$$module$js$util$util={get:async function(a){var b=new Date;return axios({url:a,method:"get",headers:{}}).then(function(c){console.log("get",": ",new Date-b);return c.data}).catch(function(c){throw Error(c);})},_change:async function(a,b,c,d){var e=new Date;d||={};return axios({url:a,method:c,headers:d,data:b,withCredentials:!0}).then(function(f){console.log(c,": ",new Date-e);return f.data}).catch(f=>
{if(f.response&&f.response.data.m)throw Error(f.response.data.m);throw Error(f.message);})},post:async function(a,b,c){return this._change(a,b,"post",c)},put:async function(a,b,c){return this._change(a,b,"put",c)},delete:async function(a,b,c){return this._change(a,b,"delete",c)}};var module$js$util$util={};module$js$util$util.FieldType=FieldType$$module$js$util$util;module$js$util$util.buildParams=buildParams$$module$js$util$util;module$js$util$util.compile_template=compile_template$$module$js$util$util;
module$js$util$util.dataset_helper=dataset_helper$$module$js$util$util;module$js$util$util.formatMoney=formatMoney$$module$js$util$util;module$js$util$util.isEmpty=isEmpty$$module$js$util$util;module$js$util$util.isNotEmpty=isNotEmpty$$module$js$util$util;module$js$util$util.loadParams=loadParams$$module$js$util$util;module$js$util$util.meta_helper=meta_helper$$module$js$util$util;module$js$util$util.parseMoneyToDecimalString=parseMoneyToDecimalString$$module$js$util$util;
module$js$util$util.record_change_helper=record_change_helper$$module$js$util$util;module$js$util$util.rest=rest$$module$js$util$util;module$js$util$util.slug=slug$$module$js$util$util;let toast_helper$$module$js$util$modal={toastTemplate:Handlebars.compile($("#toast-template").html()),show:function(a,b){$("#app-toast").html(this.toastTemplate({message:a,background:b}));(new bootstrap.Toast($("#toast"))).show()}},modal_helper$$module$js$util$modal={el:"#app-modal",m:function(){return bootstrap.Modal.getOrCreateInstance($(".modal",this.el)[0],{keyboard:!1,backdrop:"static"})},validate:function(a){a.fields.forEach(d=>{record_change_helper$$module$js$util$util.fieldInputs(d).forEach(e=>
...
this.events()}};var module$js$module$register={};module$js$module$register.Register=Register$$module$js$module$register;const Home$$module$js$module$home={el:null,template:Handlebars.compile($("#home-template").html()),events:function(){$("*[data-action='search-topic-main']").off();$("*[data-action='search-topic-main']").click(a=>{a.preventDefault();(a=$("input[data-input='search-topic-main']").val())&&""!=a.trim()?window.app.router().navigateTo(`/topic/?search=${a}`):toast_helper$$module$js$util$modal.show("Please enter search term","bg-info")})},init:function(a){this.el=a;this.render();Home$$module$js$module$home.events()},
